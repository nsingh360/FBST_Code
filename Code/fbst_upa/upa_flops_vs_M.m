...
for mm1 = 1:length(M_lst)
    ...
    Runtime_fbst_precompute(mm1) = (chirpz_time_domain + chirpz_beam_domain1 + chirpz_beam_domain2 + precompute_flops + reconstruc_flops)/N;
    Runtime_fbst_superfast(mm1) = (chirpz_time_domain + chirpz_beam_domain1 + chirpz_beam_domain2 + canonical_vec_flops + reconstruc_flops)/N;
...
exportgraphics(gcf, 'upa_flops_vs_M_subband.pdf', 'ContentType', 'vector');
