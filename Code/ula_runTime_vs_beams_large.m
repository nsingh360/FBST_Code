...
legend({'FBST Precompute inverse', 'FBST Superfast toeplitz','Delay and Sum (R=16)', 'Delay and Sum (R=32)'},'Location','northwest','Interpreter','latex')
