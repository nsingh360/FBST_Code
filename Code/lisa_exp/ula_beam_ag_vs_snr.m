...
exportgraphics(gcf, 'lisa_array_gain_unif.pdf', 'ContentType', 'vector');
...
exportgraphics(gcf, 'lisa_beam_pattern_unif.pdf', 'ContentType', 'vector');
...
exportgraphics(gcf, 'lisa_beam_pattern_nulling_unif.pdf', 'ContentType', 'vector');
